#!/usr/bin/env python3
"""Generate MuJoCo REMS Task A corridor scene beside symlinked G1 model assets."""
...
def main() -> None:
    ...
    template = repo_root / "assets/mujoco/scene_43dof_inspire_hand_corridor.xml.in"
    out_path = out_dir / "scene_43dof_inspire_hand_corridor.xml"
